...
#define PDM_MAX_BUFFER_SIZE        (16 * 4096)
#define PCM_DMA_BUFFER_SIZE        (PDM_MAX_DMA_BUFFER_SIZE / (CIC_MAX_DECIMATION_FACTOR / PCM_SAMPLE_SIZE_BITS))
#define PCM_MAX_BUFFER_SIZE        (PDM_MAX_BUFFER_SIZE / (CIC_MAX_DECIMATION_FACTOR / PCM_SAMPLE_SIZE_BITS))
...
static const struct snd_pcm_hardware snd_berlin_capture_hw = {
        ...
        .period_bytes_min = PCM_DMA_BUFFER_SIZE,
        .period_bytes_max = PCM_DMA_BUFFER_SIZE,
        .periods_min = PCM_MAX_BUFFER_SIZE / PCM_DMA_BUFFER_SIZE,
        .periods_max = PCM_MAX_BUFFER_SIZE / PCM_DMA_BUFFER_SIZE,
        .fifo_size = 0
};
