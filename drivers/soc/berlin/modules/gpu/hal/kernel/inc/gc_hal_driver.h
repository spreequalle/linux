...
#define IOCTL_GCHAL_SET_EXT_CLOCK       30003
#define IOCTL_GCHAL_GET_EXT_CLOCK       30004
#define IOCTL_GCHAL_CLOCK_UP            30008
#define IOCTL_GCHAL_CLOCK_DOWN          30009
...
typedef struct _gcsHAL_EXT_CLOCK
{
    /* Clock settings extension */
    gceEXT_PM_FLAGS             eFlags;
    gceEXT_3D_CoreClockSource   e3DCoreSource;
    gceEXT_3D_CoreClockDiv      e3DCoreDiv;
    gceEXT_3D_SysClockSource    e3DSysSource;
    gceEXT_3D_SysClockDiv       e3DSysDiv;
    gceEXT_3D_ShClockSource     e3DShSource;
    gceEXT_3D_ShClockDiv        e3DShDiv;
} gcsHAL_ExtClock;
/*###end by marvell-bg2*/
