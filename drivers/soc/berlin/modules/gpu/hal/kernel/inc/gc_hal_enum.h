...
typedef enum _gceEXT_PM_FLAGS {
    gcvEXT_PM_3D_CORE_CLOCK_SOURCE      = 0x1,
    gcvEXT_PM_3D_CORE_CLOCK_DIV         = 0x2,
    gcvEXT_PM_3D_SYS_CLOCK_SOURCE       = 0x4,
    gcvEXT_PM_3D_SYS_CLOCK_DIV          = 0x8,
    gcvEXT_PM_3D_SH_CLOCK_SOURCE        = 0x10,
    gcvEXT_PM_3D_SH_CLOCK_DIV           = 0x20,
    gcvEXT_PM_MASK                      = 0x3F,
} gceEXT_PM_FLAGS;

typedef enum _gceEXT_3D_CoreClockSource {
    gcvEXT_3D_CORE_CLOCK_AVPLLB4         = 0x0,
    gcvEXT_3D_CORE_CLOCK_AVPLLB5         = 0x1,
    gcvEXT_3D_CORE_CLOCK_AVPLLB6         = 0x2,
    gcvEXT_3D_CORE_CLOCK_AVPLLB7         = 0x3,
    gcvEXT_3D_CORE_CLOCK_SYSPLL          = 0x4,
} gceEXT_3D_CoreClockSource;

typedef enum _gceEXT_3D_CoreClockDiv {
    gcvEXT_3D_CORE_CLOCK_DIV3           = 0x0,
    gcvEXT_3D_CORE_CLOCK_DIV4           = 0x1,
    gcvEXT_3D_CORE_CLOCK_DIV6           = 0x2,
    gcvEXT_3D_CORE_CLOCK_DIV8           = 0x3,
    gcvEXT_3D_CORE_CLOCK_DIV12          = 0x4,
} gceEXT_3D_CoreClockDiv;

typedef enum _gceEXT_3D_SysClockSource {
    gcvEXT_3D_SYS_CLOCK_AVPLLB4         = 0x0,
    gcvEXT_3D_SYS_CLOCK_AVPLLB5         = 0x1,
    gcvEXT_3D_SYS_CLOCK_AVPLLB6         = 0x2,
    gcvEXT_3D_SYS_CLOCK_AVPLLB7         = 0x3,
    gcvEXT_3D_SYS_CLOCK_SYSPLL          = 0x4,
} gceEXT_3D_SysClockSource;

typedef enum _gceEXT_3D_SysClockDiv {
    gcvEXT_3D_SYS_CLOCK_DIV2           = 0x0,
    gcvEXT_3D_SYS_CLOCK_DIV3           = 0x1,
    gcvEXT_3D_SYS_CLOCK_DIV4           = 0x2,
    gcvEXT_3D_SYS_CLOCK_DIV6           = 0x3,
    gcvEXT_3D_SYS_CLOCK_DIV8           = 0x4,
    gcvEXT_3D_SYS_CLOCK_DIV12          = 0x5,
} gceEXT_3D_SysClockDiv;

typedef enum _gceEXT_3D_ShClockSource {
    gcvEXT_3D_SH_CLOCK_AVPLLB4         = 0x0,
    gcvEXT_3D_SH_CLOCK_AVPLLB5         = 0x1,
    gcvEXT_3D_SH_CLOCK_AVPLLB6         = 0x2,
    gcvEXT_3D_SH_CLOCK_AVPLLB7         = 0x3,
    gcvEXT_3D_SH_CLOCK_SYSPLL          = 0x4,
} gceEXT_3D_ShClockSource;

typedef enum _gceEXT_3D_ShClockDiv {
    gcvEXT_3D_SH_CLOCK_DIV3           = 0x0,
    gcvEXT_3D_SH_CLOCK_DIV4           = 0x1,
    gcvEXT_3D_SH_CLOCK_DIV6           = 0x2,
    gcvEXT_3D_SH_CLOCK_DIV8           = 0x3,
    gcvEXT_3D_SH_CLOCK_DIV12          = 0x4,
} gceEXT_3D_ShClockDiv;

typedef enum _gceIONMEM_USAGE_MODE {
    gcvIONMEM_USAGE_FULL             = 0x0,
    gcvIONMEM_USAGE_CONTIGUOUS       = 0x1,
    gcvIONMEM_USAGE_DEFAULT          = 0x2,
    gcvIONMEM_USAGE_NONE             = 0x3,
} gceIONMEM_USAGE_MODE;

typedef enum _gceSYSMEM_USAGE_MODE {
    gcvSYSMEM_USAGE_FULL           = 0x0,
    gcvSYSMEM_USAGE_NONE           = 0x1,
} gceSYSMEM_USAGE_MODE;
/*###end by marvell-bg2*/
...
/*###modified by marvell-bg2*/
#define gcvALLOC_FLAG_ION_BIT               5
/*###end by marvell-bg2*/
...
/*###modified by marvell-bg2*/
/* Ion buffer. */
#define gcvALLOC_FLAG_ION               (1 << gcvALLOC_FLAG_ION_BIT)
/*###end by marvell-bg2*/
