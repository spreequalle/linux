...
gckGALDEVICE_Construct(
    ...
    IN gceIONMEM_USAGE_MODE IonMemUsageMode,
    IN gceSYSMEM_USAGE_MODE SysMemUsageMode,
    /*###end by marvell-bg2*/
...
/*###modified by marvell-bg2*/
    /* setup memory configurations. */
    device->ionMemUsageMode = IonMemUsageMode;
    device->sysMemUsageMode = SysMemUsageMode;
/*###end by marvell-bg2*/
