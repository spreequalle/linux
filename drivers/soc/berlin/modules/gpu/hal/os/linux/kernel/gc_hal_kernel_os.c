    ...
    )
{
    ...
    gceIONMEM_USAGE_MODE ionMemUsageMode;
    gceSYSMEM_USAGE_MODE sysMemUsageMode;
    /*###end by marvell-bg2*/
    ...
    gcmkONERROR(gckOS_QueryOption(Os, "sysMemUsageMode", (gctUINT32 *)&sysMemUsageMode));
    /*###end by marvell-bg2*/
    ...
    /*###modified by marvell-bg2*/
    if (sysMemUsageMode != gcvSYSMEM_USAGE_NONE)
    {
        page = alloc_pages(GFP_KERNEL | gcdNOWARN, order);
    }
    else if (ionMemUsageMode != gcvIONMEM_USAGE_NONE)
    {
#if defined(SHM_FROM_SYSTEM) && SHM_FROM_SYSTEM
        gckALLOCATOR allocator = gcvNULL;
        gctUINT32 flags = gcvALLOC_FLAG_ION | gcvALLOC_FLAG_CONTIGUOUS;
        list_for_each_entry(allocator, &Os->allocatorList, head)
        {
            if ((allocator->capability & flags) != flags)
            {
                continue;
            }

            status = allocator->ops->Alloc(allocator, mdl, numPages, flags);
    ...
    )
{
    ...
    /*###modified by marvell-bg2*/
    gcmkVERIFY_OK(gckOS_QueryOption(Os, "ionMemUsageMode", (gctUINT32 *)&ionMemUsageMode));
    gcmkVERIFY_OK(gckOS_QueryOption(Os, "sysMemUsageMode", (gctUINT32 *)&sysMemUsageMode));
    /*###end by marvell-bg2*/
...
/*###modified by marvell-bg2*/
#if !gcdCACHE_FUNCTION_UNIMPLEMENTED && !(defined(SHM_FROM_SYSTEM) && SHM_FROM_SYSTEM)
...
/*###modified by marvell-bg2*/
    else if (!strcmp(Option, "ionMemUsageMode"))
    {
        *Value = (gctUINT32)device->ionMemUsageMode;
        return gcvSTATUS_OK;
    }
    else if (!strcmp(Option, "sysMemUsageMode"))
    {
        *Value = (gctUINT32)device->sysMemUsageMode;
        return gcvSTATUS_OK;
    }
/*###end by marvell-bg2*/
