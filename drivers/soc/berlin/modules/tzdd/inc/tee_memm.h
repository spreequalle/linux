...
tee_stat_t tee_memm_calc_pages_num(tee_memm_ss_t tee_memm_ss, void *virt,
					uint32_t size, uint32_t *pages_num);
tee_stat_t tee_memm_parse_phys_pages(tee_memm_ss_t tee_memm_ss, void *virt,
					uint32_t length, tee_mem_page_t *pages,
					uint32_t pages_num);
