...
#define     w32ZspGlobalRegs_subsys_reset                  {\
		...
		union {
			UNSG32 u32ZspGlobalRegs_subsys_reset;
...
#define     w32ZspGlobalRegs_core_reset                    {\
		...
		union {
			UNSG32 u32ZspGlobalRegs_core_reset;
...
#define     w32ZspGlobalRegs_clock_ctrl                    {\
		...
		union {
			UNSG32 u32ZspGlobalRegs_clock_ctrl;
...
#define     w32ZspGlobalRegs_ext_bp                        {\
		...
		union {
			UNSG32 u32ZspGlobalRegs_ext_bp;
...
#define     w32ZspGlobalRegs_status                        {\
		...
		union {
			UNSG32 u32ZspGlobalRegs_status;
...
#define     w32ZspGlobalRegs_svtaddr                       {\
		...
		union {
			UNSG32 u32ZspGlobalRegs_svtaddr;
	...
	///////////////////////////////////////////////////////////
	SIGN32 ZspGlobalRegs_drvrd(SIE_ZspGlobalRegs * p, UNSG32 base,
				   SIGN32 mem, SIGN32 tst);
	SIGN32 ZspGlobalRegs_drvwr(SIE_ZspGlobalRegs * p, UNSG32 base,
				   SIGN32 mem, SIGN32 tst, UNSG32 * pcmd);
	void ZspGlobalRegs_reset(SIE_ZspGlobalRegs * p);
	SIGN32 ZspGlobalRegs_cmp(SIE_ZspGlobalRegs * p, SIE_ZspGlobalRegs * pie,
...
#define     w32ZspInt2Zsp_clear                            {\
	...
	///////////////////////////////////////////////////////////
	SIGN32 ZspInt2Zsp_drvrd(SIE_ZspInt2Zsp * p, UNSG32 base, SIGN32 mem,
				SIGN32 tst);
	SIGN32 ZspInt2Zsp_drvwr(SIE_ZspInt2Zsp * p, UNSG32 base, SIGN32 mem,
				SIGN32 tst, UNSG32 * pcmd);
	void ZspInt2Zsp_reset(SIE_ZspInt2Zsp * p);
	SIGN32 ZspInt2Zsp_cmp(SIE_ZspInt2Zsp * p, SIE_ZspInt2Zsp * pie,
			      char *pfx, void *hLOG, SIGN32 mem, SIGN32 tst);
...
#define     w32ZspInt2Soc_enable                           {\
	...
	///////////////////////////////////////////////////////////
	SIGN32 ZspInt2Soc_drvrd(SIE_ZspInt2Soc * p, UNSG32 base, SIGN32 mem,
				SIGN32 tst);
	SIGN32 ZspInt2Soc_drvwr(SIE_ZspInt2Soc * p, UNSG32 base, SIGN32 mem,
				SIGN32 tst, UNSG32 * pcmd);
	void ZspInt2Soc_reset(SIE_ZspInt2Soc * p);
	SIGN32 ZspInt2Soc_cmp(SIE_ZspInt2Soc * p, SIE_ZspInt2Soc * pie,
			      char *pfx, void *hLOG, SIGN32 mem, SIGN32 tst);
...
#define     w32ZspDmaRegs_status                           {\
	...
	///////////////////////////////////////////////////////////
	SIGN32 ZspDmaRegs_drvrd(SIE_ZspDmaRegs * p, UNSG32 base, SIGN32 mem,
				SIGN32 tst);
	SIGN32 ZspDmaRegs_drvwr(SIE_ZspDmaRegs * p, UNSG32 base, SIGN32 mem,
				SIGN32 tst, UNSG32 * pcmd);
	void ZspDmaRegs_reset(SIE_ZspDmaRegs * p);
	SIGN32 ZspDmaRegs_cmp(SIE_ZspDmaRegs * p, SIE_ZspDmaRegs * pie,
			      char *pfx, void *hLOG, SIGN32 mem, SIGN32 tst);
...
#define     w32ZspRegs_ZXBAR                               {\
	...
	///////////////////////////////////////////////////////////
	SIGN32 ZspRegs_drvrd(SIE_ZspRegs * p, UNSG32 base, SIGN32 mem,
			     SIGN32 tst);
	SIGN32 ZspRegs_drvwr(SIE_ZspRegs * p, UNSG32 base, SIGN32 mem,
			     SIGN32 tst, UNSG32 * pcmd);
	void ZspRegs_reset(SIE_ZspRegs * p);
	SIGN32 ZspRegs_cmp(SIE_ZspRegs * p, SIE_ZspRegs * pie, char *pfx,
