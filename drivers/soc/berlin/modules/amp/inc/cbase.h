...
#else
#define	IO32RD(d, a)				do{	(d) = *(volatile UNSG32*)amp_memmap_phy_to_vir(a); }while(0)
#define	IO32WR(d, a)				do{	*(volatile UNSG32*)amp_memmap_phy_to_vir(a) = (d); }while(0)
#endif
