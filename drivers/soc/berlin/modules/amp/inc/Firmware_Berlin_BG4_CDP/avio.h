...
#define   SET32oneReg_0x00000000(r32,v)                    _BFSET_(r32,31, 0,v)
	...
	///////////////////////////////////////////////////////////
	SIGN32 oneReg_drvrd(SIE_oneReg * p, UNSG32 base, SIGN32 mem,
			    SIGN32 tst);
	SIGN32 oneReg_drvwr(SIE_oneReg * p, UNSG32 base, SIGN32 mem, SIGN32 tst,
			    UNSG32 * pcmd);
	void oneReg_reset(SIE_oneReg * p);
	SIGN32 oneReg_cmp(SIE_oneReg * p, SIE_oneReg * pie, char *pfx,
...
#define     RA_AVIO_REG_dummy                              0x0000
	...
	///////////////////////////////////////////////////////////
	SIGN32 AVIO_REG_drvrd(SIE_AVIO_REG * p, UNSG32 base, SIGN32 mem,
			      SIGN32 tst);
	SIGN32 AVIO_REG_drvwr(SIE_AVIO_REG * p, UNSG32 base, SIGN32 mem,
			      SIGN32 tst, UNSG32 * pcmd);
	void AVIO_REG_reset(SIE_AVIO_REG * p);
	SIGN32 AVIO_REG_cmp(SIE_AVIO_REG * p, SIE_AVIO_REG * pie, char *pfx,
			    void *hLOG, SIGN32 mem, SIGN32 tst);
...
#define   SET16OCCURENCE_AUTO_PUSH_CNT(r16,v)              _BFSET_(r16, 7, 0,v)
	...
	///////////////////////////////////////////////////////////
	SIGN32 OCCURENCE_drvrd(SIE_OCCURENCE * p, UNSG32 base, SIGN32 mem,
			       SIGN32 tst);
	SIGN32 OCCURENCE_drvwr(SIE_OCCURENCE * p, UNSG32 base, SIGN32 mem,
			       SIGN32 tst, UNSG32 * pcmd);
	void OCCURENCE_reset(SIE_OCCURENCE * p);
	SIGN32 OCCURENCE_cmp(SIE_OCCURENCE * p, SIE_OCCURENCE * pie, char *pfx,
			     void *hLOG, SIGN32 mem, SIGN32 tst);
...
#define     w32AVIO_BCM_AUTOPUSH_CNT                       {\
		...
		union {
			UNSG32 u32AVIO_BCM_AUTOPUSH_CNT;
...
#define     w32AVIO_BCM_FULL_STS_STICKY                    {\
		...
		union {
			UNSG32 u32AVIO_BCM_FULL_STS_STICKY;
...
#define     w32AVIO_BCM_ERROR_DATA                         {\
	...
	SIGN32 AVIO_drvwr(SIE_AVIO * p, UNSG32 base, SIGN32 mem, SIGN32 tst,
			  UNSG32 * pcmd);
	void AVIO_reset(SIE_AVIO * p);
	SIGN32 AVIO_cmp(SIE_AVIO * p, SIE_AVIO * pie, char *pfx, void *hLOG,
