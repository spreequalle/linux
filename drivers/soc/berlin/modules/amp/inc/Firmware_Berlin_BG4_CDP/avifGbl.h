...
#define     RA_Demod_REG_dummy                             0x0000
	...
	///////////////////////////////////////////////////////////
	SIGN32 Demod_REG_drvrd(SIE_Demod_REG * p, UNSG32 base, SIGN32 mem,
			       SIGN32 tst);
	SIGN32 Demod_REG_drvwr(SIE_Demod_REG * p, UNSG32 base, SIGN32 mem,
			       SIGN32 tst, UNSG32 * pcmd);
	void Demod_REG_reset(SIE_Demod_REG * p);
	SIGN32 Demod_REG_cmp(SIE_Demod_REG * p, SIE_Demod_REG * pie, char *pfx,
			     void *hLOG, SIGN32 mem, SIGN32 tst);
...
#define     w32avifGbl_DemodRegIfCtrl                      {\
		...
		union {
			UNSG32 u32avifGbl_DemodRegIfCtrl;
...
#define     w32avifGbl_DemodADC_Status                     {\
		...
		union {
			UNSG32 u32avifGbl_DemodADC_Status;
...
#define     w32avifGbl_DemodADC_Func                       {\
		...
		union {
			UNSG32 u32avifGbl_DemodADC_Func;
...
#define     w32avifGbl_DemodADC_CurrentCntrl               {\
		...
		union {
			UNSG32 u32avifGbl_DemodADC_CurrentCntrl;
...
#define     w32avifGbl_DemodADC_CalCntrl                   {\
		...
		union {
			UNSG32 u32avifGbl_DemodADC_CalCntrl;
...
#define     w32avifGbl_DemodADC_TestCntrl                  {\
		...
		union {
			UNSG32 u32avifGbl_DemodADC_TestCntrl;
...
#define     w32avifGbl_DemodADC_SpareCntrl                 {\
		...
		union {
			UNSG32 u32avifGbl_DemodADC_SpareCntrl;
	...
	///////////////////////////////////////////////////////////
	SIGN32 avifGbl_drvrd(SIE_avifGbl * p, UNSG32 base, SIGN32 mem,
			     SIGN32 tst);
	SIGN32 avifGbl_drvwr(SIE_avifGbl * p, UNSG32 base, SIGN32 mem,
			     SIGN32 tst, UNSG32 * pcmd);
	void avifGbl_reset(SIE_avifGbl * p);
	SIGN32 avifGbl_cmp(SIE_avifGbl * p, SIE_avifGbl * pie, char *pfx,
			   void *hLOG, SIGN32 mem, SIGN32 tst);
