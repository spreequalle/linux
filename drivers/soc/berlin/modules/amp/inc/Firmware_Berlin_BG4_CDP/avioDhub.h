...
//////
/// don't edit! auto-generated by docc: avioDhub.h
////////////////////////////////////////////////////////////
#ifndef avioDhub_h
#define avioDhub_h (){}
...
#define     w32SemaINTR_mask                               {\
	...
	///////////////////////////////////////////////////////////
	SIGN32 SemaINTR_drvrd(SIE_SemaINTR * p, UNSG32 base, SIGN32 mem,
			      SIGN32 tst);
	SIGN32 SemaINTR_drvwr(SIE_SemaINTR * p, UNSG32 base, SIGN32 mem,
			      SIGN32 tst, UNSG32 * pcmd);
	void SemaINTR_reset(SIE_SemaINTR * p);
	SIGN32 SemaINTR_cmp(SIE_SemaINTR * p, SIE_SemaINTR * pie, char *pfx,
...
#define     w32Semaphore_mask                              {\
	...
	///////////////////////////////////////////////////////////
	SIGN32 Semaphore_drvrd(SIE_Semaphore * p, UNSG32 base, SIGN32 mem,
			       SIGN32 tst);
	SIGN32 Semaphore_drvwr(SIE_Semaphore * p, UNSG32 base, SIGN32 mem,
			       SIGN32 tst, UNSG32 * pcmd);
	void Semaphore_reset(SIE_Semaphore * p);
	SIGN32 Semaphore_cmp(SIE_Semaphore * p, SIE_Semaphore * pie, char *pfx,
			     void *hLOG, SIGN32 mem, SIGN32 tst);
...
#define     w32SemaQuery_RESP                              {\
	...
	///////////////////////////////////////////////////////////
	SIGN32 SemaQuery_drvrd(SIE_SemaQuery * p, UNSG32 base, SIGN32 mem,
			       SIGN32 tst);
	SIGN32 SemaQuery_drvwr(SIE_SemaQuery * p, UNSG32 base, SIGN32 mem,
			       SIGN32 tst, UNSG32 * pcmd);
	void SemaQuery_reset(SIE_SemaQuery * p);
	SIGN32 SemaQuery_cmp(SIE_SemaQuery * p, SIE_SemaQuery * pie, char *pfx,
			     void *hLOG, SIGN32 mem, SIGN32 tst);
...
#define     w32SemaQueryMap_ADDR                           {\
	...
	///////////////////////////////////////////////////////////
	SIGN32 SemaQueryMap_drvrd(SIE_SemaQueryMap * p, UNSG32 base, SIGN32 mem,
				  SIGN32 tst);
	SIGN32 SemaQueryMap_drvwr(SIE_SemaQueryMap * p, UNSG32 base, SIGN32 mem,
				  SIGN32 tst, UNSG32 * pcmd);
	void SemaQueryMap_reset(SIE_SemaQueryMap * p);
	SIGN32 SemaQueryMap_cmp(SIE_SemaQueryMap * p, SIE_SemaQueryMap * pie,
...
#define     w32SemaHub_almostFull                          {\
	...
	///////////////////////////////////////////////////////////
	SIGN32 SemaHub_drvrd(SIE_SemaHub * p, UNSG32 base, SIGN32 mem,
			     SIGN32 tst);
	SIGN32 SemaHub_drvwr(SIE_SemaHub * p, UNSG32 base, SIGN32 mem,
			     SIGN32 tst, UNSG32 * pcmd);
	void SemaHub_reset(SIE_SemaHub * p);
	SIGN32 SemaHub_cmp(SIE_SemaHub * p, SIE_SemaHub * pie, char *pfx,
			   void *hLOG, SIGN32 mem, SIGN32 tst);
...
#define     w32FiFo_FLUSH                                  {\
	...
	SIGN32 FiFo_drvwr(SIE_FiFo * p, UNSG32 base, SIGN32 mem, SIGN32 tst,
			  UNSG32 * pcmd);
	void FiFo_reset(SIE_FiFo * p);
	SIGN32 FiFo_cmp(SIE_FiFo * p, SIE_FiFo * pie, char *pfx, void *hLOG,
...
#define     w32HBO_BUSY                                    {\
	...
	SIGN32 HBO_drvwr(SIE_HBO * p, UNSG32 base, SIGN32 mem, SIGN32 tst,
			 UNSG32 * pcmd);
	void HBO_reset(SIE_HBO * p);
	SIGN32 HBO_cmp(SIE_HBO * p, SIE_HBO * pie, char *pfx, void *hLOG,
		       SIGN32 mem, SIGN32 tst);
...
#define     w32LLDesFmt_mem                                {\
	...
	///////////////////////////////////////////////////////////
	SIGN32 LLDesFmt_drvrd(SIE_LLDesFmt * p, UNSG32 base, SIGN32 mem,
			      SIGN32 tst);
	SIGN32 LLDesFmt_drvwr(SIE_LLDesFmt * p, UNSG32 base, SIGN32 mem,
			      SIGN32 tst, UNSG32 * pcmd);
	void LLDesFmt_reset(SIE_LLDesFmt * p);
	SIGN32 LLDesFmt_cmp(SIE_LLDesFmt * p, SIE_LLDesFmt * pie, char *pfx,
			    void *hLOG, SIGN32 mem, SIGN32 tst);
...
#define     BA_dHubCmdHDR_DESC_dis_chk                     0x0003
#define     B16dHubCmdHDR_DESC_dis_chk                     0x0002
#define   LSb32dHubCmdHDR_DESC_dis_chk                        29
#define   LSb16dHubCmdHDR_DESC_dis_chk                        13
#define       bdHubCmdHDR_DESC_dis_chk                     1
#define   MSK32dHubCmdHDR_DESC_dis_chk                        0x20000000

#define     BA_dHubCmdHDR_DESC_dis_upd                     0x0003
#define     B16dHubCmdHDR_DESC_dis_upd                     0x0002
#define   LSb32dHubCmdHDR_DESC_dis_upd                        30
#define   LSb16dHubCmdHDR_DESC_dis_upd                        14
#define       bdHubCmdHDR_DESC_dis_upd                     1
#define   MSK32dHubCmdHDR_DESC_dis_upd                        0x40000000
	///////////////////////////////////////////////////////////
...
#define   GET32dHubCmdHDR_DESC_dis_chk(r32)                _BFGET_(r32,29,29)
#define   SET32dHubCmdHDR_DESC_dis_chk(r32,v)              _BFSET_(r32,29,29,v)
#define   GET16dHubCmdHDR_DESC_dis_chk(r16)                _BFGET_(r16,13,13)
#define   SET16dHubCmdHDR_DESC_dis_chk(r16,v)              _BFSET_(r16,13,13,v)

#define   GET32dHubCmdHDR_DESC_dis_upd(r32)                _BFGET_(r32,30,30)
#define   SET32dHubCmdHDR_DESC_dis_upd(r32,v)              _BFSET_(r32,30,30,v)
#define   GET16dHubCmdHDR_DESC_dis_upd(r16)                _BFGET_(r16,14,14)
#define   SET16dHubCmdHDR_DESC_dis_upd(r16,v)              _BFSET_(r16,14,14,v)
...
#define     w32dHubCmdHDR_DESC                             {\
	...
	///////////////////////////////////////////////////////////
	SIGN32 dHubCmdHDR_drvrd(SIE_dHubCmdHDR * p, UNSG32 base, SIGN32 mem,
				SIGN32 tst);
	SIGN32 dHubCmdHDR_drvwr(SIE_dHubCmdHDR * p, UNSG32 base, SIGN32 mem,
				SIGN32 tst, UNSG32 * pcmd);
	void dHubCmdHDR_reset(SIE_dHubCmdHDR * p);
	SIGN32 dHubCmdHDR_cmp(SIE_dHubCmdHDR * p, SIE_dHubCmdHDR * pie,
			      char *pfx, void *hLOG, SIGN32 mem, SIGN32 tst);
...
#define     w32dHubCmd_MEM                                 {\
	...
	///////////////////////////////////////////////////////////
	SIGN32 dHubCmd_drvrd(SIE_dHubCmd * p, UNSG32 base, SIGN32 mem,
			     SIGN32 tst);
	SIGN32 dHubCmd_drvwr(SIE_dHubCmd * p, UNSG32 base, SIGN32 mem,
			     SIGN32 tst, UNSG32 * pcmd);
	void dHubCmd_reset(SIE_dHubCmd * p);
	SIGN32 dHubCmd_cmp(SIE_dHubCmd * p, SIE_dHubCmd * pie, char *pfx,
			   void *hLOG, SIGN32 mem, SIGN32 tst);
...
#define        dHubChannel_CFG_MTU_4096byte                             0x3
...
#define        dHubChannel_CFG_vScan_invScan                            0x1
	///////////////////////////////////////////////////////////
#define     RA_dHubChannel_START                        ((berlin_chip_revision < \
                                                        BERLIN_BG4CDP_A0_EXT)?0x0004 : \
                                                        0x0010)

#define     BA_dHubChannel_START_EN                     ((berlin_chip_revision < \
                                                        BERLIN_BG4CDP_A0_EXT)?0x0004 : \
                                                        0x0010)
#define     B16dHubChannel_START_EN                     ((berlin_chip_revision < \
                                                        BERLIN_BG4CDP_A0_EXT)?0x0004 : \
                                                        0x0010)
...
#define   MSK32dHubChannel_START_EN                           0x00000001
	///////////////////////////////////////////////////////////
#define     RA_dHubChannel_CLEAR                           ((berlin_chip_revision < \
                                                            BERLIN_BG4CDP_A0_EXT)?0x0008 : \
                                                            0x0014)
#define     BA_dHubChannel_CLEAR_EN                        ((berlin_chip_revision < \
                                                            BERLIN_BG4CDP_A0_EXT)?0x0008 : \
                                                            0x0014)
#define     B16dHubChannel_CLEAR_EN                        ((berlin_chip_revision < \
                                                            BERLIN_BG4CDP_A0_EXT)?0x0008 : \
                                                            0x0014)
...
#define   MSK32dHubChannel_CLEAR_EN                           0x00000001
	///////////////////////////////////////////////////////////
#define     RA_dHubChannel_FLUSH                           ((berlin_chip_revision < \
                                                            BERLIN_BG4CDP_A0_EXT)?0x000C : \
                                                            0x0018)
#define     BA_dHubChannel_FLUSH_EN                        ((berlin_chip_revision < \
                                                            BERLIN_BG4CDP_A0_EXT)?0x000C : \
                                                            0x0018)
#define     B16dHubChannel_FLUSH_EN                        ((berlin_chip_revision < \
                                                            BERLIN_BG4CDP_A0_EXT)?0x000C : \
                                                            0x0018)
...
#define     w32dHubChannel_FLUSH                           {\
	...
	///////////////////////////////////////////////////////////
	SIGN32 dHubChannel_drvrd(SIE_dHubChannel * p, UNSG32 base, SIGN32 mem,
				 SIGN32 tst);
	SIGN32 dHubChannel_drvwr(SIE_dHubChannel * p, UNSG32 base, SIGN32 mem,
				 SIGN32 tst, UNSG32 * pcmd);
	void dHubChannel_reset(SIE_dHubChannel * p);
	SIGN32 dHubChannel_cmp(SIE_dHubChannel * p, SIE_dHubChannel * pie,
			       char *pfx, void *hLOG, SIGN32 mem, SIGN32 tst);
...
#define     RA_dHubReg_channelCtl                          0x0B00
	///////////////////////////////////////////////////////////
#define     RA_dHubReg_BUSY                                ((berlin_chip_revision < \
                                                            BERLIN_BG4CDP_A0_EXT)?0x0C00 : \
                                                            0x0CC0)

#define     BA_dHubReg_BUSY_ST                             ((berlin_chip_revision < \
                                                            BERLIN_BG4CDP_A0_EXT)?0x0C00 : \
                                                            0x0CC0)
#define     B16dHubReg_BUSY_ST                             ((berlin_chip_revision < \
                                                            BERLIN_BG4CDP_A0_EXT)?0x0C00 : \
                                                            0x0CC0)
...
#define   MSK32dHubReg_BUSY_ST                                0x0000FFFF
	///////////////////////////////////////////////////////////
#define     RA_dHubReg_PENDING                             ((berlin_chip_revision < \
                                                            BERLIN_BG4CDP_A0_EXT)?0x0C04 : \
                                                            0x0CC4)

#define     BA_dHubReg_PENDING_ST                          ((berlin_chip_revision < \
                                                            BERLIN_BG4CDP_A0_EXT)?0x0C04 : \
                                                            0x0CC4)
#define     B16dHubReg_PENDING_ST                          ((berlin_chip_revision < \
                                                            BERLIN_BG4CDP_A0_EXT)?0x0C04 : \
                                                            0x0CC4)
...
#define   MSK32dHubReg_PENDING_ST                             0x0000FFFF
	///////////////////////////////////////////////////////////
#define     RA_dHubReg_busRstEn                            ((berlin_chip_revision < \
                                                            BERLIN_BG4CDP_A0_EXT)?0x0C08 : \
                                                            0x0CC8)

#define     BA_dHubReg_busRstEn_reg                        ((berlin_chip_revision < \
                                                            BERLIN_BG4CDP_A0_EXT)?0x0C08 : \
                                                            0x0CC8)
#define     B16dHubReg_busRstEn_reg                        ((berlin_chip_revision < \
                                                            BERLIN_BG4CDP_A0_EXT)?0x0C08 : \
                                                            0x0CC8)
...
#define   MSK32dHubReg_busRstEn_reg                           0x00000001
	///////////////////////////////////////////////////////////
#define     RA_dHubReg_busRstDone                          ((berlin_chip_revision < \
                                                            BERLIN_BG4CDP_A0_EXT)?0x0C0C : \
                                                            0x0CCC)

#define     BA_dHubReg_busRstDone_reg                      ((berlin_chip_revision < \
                                                            BERLIN_BG4CDP_A0_EXT)?0x0C0C : \
                                                            0x0CCC)
#define     B16dHubReg_busRstDone_reg                      ((berlin_chip_revision < \
                                                            BERLIN_BG4CDP_A0_EXT)?0x0C0C : \
                                                            0x0CCC)
...
#define   MSK32dHubReg_busRstDone_reg                         0x00000001
	///////////////////////////////////////////////////////////
#define     RA_dHubReg_flowCtl                             ((berlin_chip_revision < \
                                                            BERLIN_BG4CDP_A0_EXT)?0x0C10 : \
                                                            0x0CD0)

#define     BA_dHubReg_flowCtl_rAlpha                      ((berlin_chip_revision < \
                                                            BERLIN_BG4CDP_A0_EXT)?0x0C10 : \
                                                            0x0CD0)
#define     B16dHubReg_flowCtl_rAlpha                      ((berlin_chip_revision < \
                                                            BERLIN_BG4CDP_A0_EXT)?0x0C10 : \
                                                            0x0CD0)
...
#define     BA_dHubReg_flowCtl_wAlpha                      ((berlin_chip_revision < \
                                                            BERLIN_BG4CDP_A0_EXT)?0x0C11 : \
                                                            0x0CD1)
#define     B16dHubReg_flowCtl_wAlpha                      ((berlin_chip_revision < \
                                                            BERLIN_BG4CDP_A0_EXT)?0x0C10 : \
                                                            0x0CD0)
...
#define   MSK32dHubReg_flowCtl_wAlpha                         0x0000FF00
	///////////////////////////////////////////////////////////
#define     RA_dHubReg_axiCmdCol                           ((berlin_chip_revision < \
                                                            BERLIN_BG4CDP_A0_EXT)?0x0C14 : \
                                                            0x0CD4)

#define     BA_dHubReg_axiCmdCol_rCnt                      ((berlin_chip_revision < \
                                                            BERLIN_BG4CDP_A0_EXT)?0x0C14 : \
                                                            0x0CD4)
#define     B16dHubReg_axiCmdCol_rCnt                      ((berlin_chip_revision < \
                                                            BERLIN_BG4CDP_A0_EXT)?0x0C14 : \
                                                            0x0CD4)
...
#define     BA_dHubReg_axiCmdCol_wCnt                      ((berlin_chip_revision < \
                                                            BERLIN_BG4CDP_A0_EXT)?0x0C16 : \
                                                            0x0CD6)
#define     B16dHubReg_axiCmdCol_wCnt                      ((berlin_chip_revision < \
                                                            BERLIN_BG4CDP_A0_EXT)?0x0C16 : \
                                                            0x0CD6)
...
#define     w32dHubReg_axiCmdCol                           {\
	...
	///////////////////////////////////////////////////////////
	SIGN32 dHubReg_drvrd(SIE_dHubReg * p, UNSG32 base, SIGN32 mem,
			     SIGN32 tst);
	SIGN32 dHubReg_drvwr(SIE_dHubReg * p, UNSG32 base, SIGN32 mem,
			     SIGN32 tst, UNSG32 * pcmd);
	void dHubReg_reset(SIE_dHubReg * p);
	SIGN32 dHubReg_cmp(SIE_dHubReg * p, SIE_dHubReg * pie, char *pfx,
			   void *hLOG, SIGN32 mem, SIGN32 tst);
...
#define     w32dHubCmd2D_CLEAR                             {\
	...
	///////////////////////////////////////////////////////////
	SIGN32 dHubCmd2D_drvrd(SIE_dHubCmd2D * p, UNSG32 base, SIGN32 mem,
			       SIGN32 tst);
	SIGN32 dHubCmd2D_drvwr(SIE_dHubCmd2D * p, UNSG32 base, SIGN32 mem,
			       SIGN32 tst, UNSG32 * pcmd);
	void dHubCmd2D_reset(SIE_dHubCmd2D * p);
	SIGN32 dHubCmd2D_cmp(SIE_dHubCmd2D * p, SIE_dHubCmd2D * pie, char *pfx,
			     void *hLOG, SIGN32 mem, SIGN32 tst);
...
///               %%        3          # Stuffing bits...
///     @ 0x00008 DESC_1D              (W-)
///               %unsigned 16 step                      0x1
///                                    ###
///                                    * Number of bytes to step per address.
///                                    * Signed 16-bit 2's complement number
///                                    * -32767 to +32766
///                                    * Value of 0 is invalid and treated as 1
///                                    ###
///               %unsigned 16 size                      0x1
///                                    ###
...
///               %%        31         # Stuffing bits...
///     # # ----------------------------------------------------------
/// $ENDOFINTERFACE  # size:      24B, bits:     127b, padding:     0B
////////////////////////////////////////////////////////////
#ifndef h_dHubCmd2ND
#define h_dHubCmd2ND (){}
...
#define     BA_dHubCmd2ND_DESC_dis_chk                     0x0007
#define     B16dHubCmd2ND_DESC_dis_chk                     0x0006
#define   LSb32dHubCmd2ND_DESC_dis_chk                        27
#define   LSb16dHubCmd2ND_DESC_dis_chk                        11
#define       bdHubCmd2ND_DESC_dis_chk                     1
#define   MSK32dHubCmd2ND_DESC_dis_chk                        0x08000000

#define     BA_dHubCmd2ND_DESC_dis_upd                     0x0007
#define     B16dHubCmd2ND_DESC_dis_upd                     0x0006
#define   LSb32dHubCmd2ND_DESC_dis_upd                        28
#define   LSb16dHubCmd2ND_DESC_dis_upd                        12
#define       bdHubCmd2ND_DESC_dis_upd                     1
#define   MSK32dHubCmd2ND_DESC_dis_upd                        0x10000000
	///////////////////////////////////////////////////////////
#define     RA_dHubCmd2ND_DESC_1D                          0x0008

#define     BA_dHubCmd2ND_DESC_1D_step                     0x0008
#define     B16dHubCmd2ND_DESC_1D_step                     0x0008
#define   LSb32dHubCmd2ND_DESC_1D_step                        0
#define   LSb16dHubCmd2ND_DESC_1D_step                        0
#define       bdHubCmd2ND_DESC_1D_step                     16
#define   MSK32dHubCmd2ND_DESC_1D_step                        0x0000FFFF

#define     BA_dHubCmd2ND_DESC_1D_size                     0x000A
#define     B16dHubCmd2ND_DESC_1D_size                     0x000A
#define   LSb32dHubCmd2ND_DESC_1D_size                        16
#define   LSb16dHubCmd2ND_DESC_1D_size                        0
#define       bdHubCmd2ND_DESC_1D_size                     16
#define   MSK32dHubCmd2ND_DESC_1D_size                        0xFFFF0000
	///////////////////////////////////////////////////////////
#define     RA_dHubCmd2ND_DESC_2D                          0x000C

#define     BA_dHubCmd2ND_DESC_2D_step                     0x000C
#define     B16dHubCmd2ND_DESC_2D_step                     0x000C
#define   LSb32dHubCmd2ND_DESC_2D_step                        0
#define   LSb16dHubCmd2ND_DESC_2D_step                        0
#define       bdHubCmd2ND_DESC_2D_step                     16
#define   MSK32dHubCmd2ND_DESC_2D_step                        0x0000FFFF

#define     BA_dHubCmd2ND_DESC_2D_size                     0x000E
#define     B16dHubCmd2ND_DESC_2D_size                     0x000E
#define   LSb32dHubCmd2ND_DESC_2D_size                        16
#define   LSb16dHubCmd2ND_DESC_2D_size                        0
#define       bdHubCmd2ND_DESC_2D_size                     16
#define   MSK32dHubCmd2ND_DESC_2D_size                        0xFFFF0000
	///////////////////////////////////////////////////////////
#define     RA_dHubCmd2ND_START                            0x0010

#define     BA_dHubCmd2ND_START_EN                         0x0010
#define     B16dHubCmd2ND_START_EN                         0x0010
...
#define   MSK32dHubCmd2ND_START_EN                            0x00000001
	///////////////////////////////////////////////////////////
#define     RA_dHubCmd2ND_CLEAR                            0x0014

#define     BA_dHubCmd2ND_CLEAR_EN                         0x0014
#define     B16dHubCmd2ND_CLEAR_EN                         0x0014
...
#define   GET32dHubCmd2ND_DESC_dis_chk(r32)                _BFGET_(r32,27,27)
#define   SET32dHubCmd2ND_DESC_dis_chk(r32,v)              _BFSET_(r32,27,27,v)
#define   GET16dHubCmd2ND_DESC_dis_chk(r16)                _BFGET_(r16,11,11)
#define   SET16dHubCmd2ND_DESC_dis_chk(r16,v)              _BFSET_(r16,11,11,v)

#define   GET32dHubCmd2ND_DESC_dis_upd(r32)                _BFGET_(r32,28,28)
#define   SET32dHubCmd2ND_DESC_dis_upd(r32,v)              _BFSET_(r32,28,28,v)
#define   GET16dHubCmd2ND_DESC_dis_upd(r16)                _BFGET_(r16,12,12)
#define   SET16dHubCmd2ND_DESC_dis_upd(r16,v)              _BFSET_(r16,12,12,v)
...
#define     w32dHubCmd2ND_DESC                             {\
		...
		union {
			UNSG32 u32dHubCmd2ND_DESC;
			struct w32dHubCmd2ND_DESC;
		};
		///////////////////////////////////////////////////////////
#define   GET32dHubCmd2ND_DESC_1D_step(r32)                _BFGET_(r32,15, 0)
#define   SET32dHubCmd2ND_DESC_1D_step(r32,v)              _BFSET_(r32,15, 0,v)
#define   GET16dHubCmd2ND_DESC_1D_step(r16)                _BFGET_(r16,15, 0)
#define   SET16dHubCmd2ND_DESC_1D_step(r16,v)              _BFSET_(r16,15, 0,v)

#define   GET32dHubCmd2ND_DESC_1D_size(r32)                _BFGET_(r32,31,16)
#define   SET32dHubCmd2ND_DESC_1D_size(r32,v)              _BFSET_(r32,31,16,v)
#define   GET16dHubCmd2ND_DESC_1D_size(r16)                _BFGET_(r16,15, 0)
#define   SET16dHubCmd2ND_DESC_1D_size(r16,v)              _BFSET_(r16,15, 0,v)

#define     w32dHubCmd2ND_DESC_1D                          {\
            UNSG32 uDESC_1D_step                               : 16;\
            UNSG32 uDESC_1D_size                               : 16;\
          }
		union {
			UNSG32 u32dHubCmd2ND_DESC_1D;
			struct w32dHubCmd2ND_DESC_1D;
		};
		///////////////////////////////////////////////////////////
#define   GET32dHubCmd2ND_DESC_2D_step(r32)                _BFGET_(r32,15, 0)
#define   SET32dHubCmd2ND_DESC_2D_step(r32,v)              _BFSET_(r32,15, 0,v)
#define   GET16dHubCmd2ND_DESC_2D_step(r16)                _BFGET_(r16,15, 0)
#define   SET16dHubCmd2ND_DESC_2D_step(r16,v)              _BFSET_(r16,15, 0,v)

#define   GET32dHubCmd2ND_DESC_2D_size(r32)                _BFGET_(r32,31,16)
#define   SET32dHubCmd2ND_DESC_2D_size(r32,v)              _BFSET_(r32,31,16,v)
#define   GET16dHubCmd2ND_DESC_2D_size(r16)                _BFGET_(r16,15, 0)
#define   SET16dHubCmd2ND_DESC_2D_size(r16,v)              _BFSET_(r16,15, 0,v)

#define     w32dHubCmd2ND_DESC_2D                          {\
            UNSG32 uDESC_2D_step                               : 16;\
            UNSG32 uDESC_2D_size                               : 16;\
          }
		union {
			UNSG32 u32dHubCmd2ND_DESC_2D;
			struct w32dHubCmd2ND_DESC_2D;
		};
		///////////////////////////////////////////////////////////
...
#define     w32dHubCmd2ND_CLEAR                            {\
	...
	typedef union T32dHubCmd2ND_DESC_1D {
		UNSG32 u32;
		struct w32dHubCmd2ND_DESC_1D;
	} T32dHubCmd2ND_DESC_1D;
	typedef union T32dHubCmd2ND_DESC_2D {
		UNSG32 u32;
		struct w32dHubCmd2ND_DESC_2D;
	} T32dHubCmd2ND_DESC_2D;
	...
	typedef union TdHubCmd2ND_DESC_1D {
		UNSG32 u32[1];
		struct {
			struct w32dHubCmd2ND_DESC_1D;
		};
	} TdHubCmd2ND_DESC_1D;
	typedef union TdHubCmd2ND_DESC_2D {
		UNSG32 u32[1];
		struct {
			struct w32dHubCmd2ND_DESC_2D;
		};
	...
	///////////////////////////////////////////////////////////
	SIGN32 dHubCmd2ND_drvrd(SIE_dHubCmd2ND * p, UNSG32 base, SIGN32 mem,
				SIGN32 tst);
	SIGN32 dHubCmd2ND_drvwr(SIE_dHubCmd2ND * p, UNSG32 base, SIGN32 mem,
				SIGN32 tst, UNSG32 * pcmd);
	void dHubCmd2ND_reset(SIE_dHubCmd2ND * p);
	SIGN32 dHubCmd2ND_cmp(SIE_dHubCmd2ND * p, SIE_dHubCmd2ND * pie,
			      char *pfx, void *hLOG, SIGN32 mem, SIGN32 tst);
...
#define     w32dHubQuery_RESP                              {\
	...
	///////////////////////////////////////////////////////////
	SIGN32 dHubQuery_drvrd(SIE_dHubQuery * p, UNSG32 base, SIGN32 mem,
			       SIGN32 tst);
	SIGN32 dHubQuery_drvwr(SIE_dHubQuery * p, UNSG32 base, SIGN32 mem,
			       SIGN32 tst, UNSG32 * pcmd);
	void dHubQuery_reset(SIE_dHubQuery * p);
	SIGN32 dHubQuery_cmp(SIE_dHubQuery * p, SIE_dHubQuery * pie, char *pfx,
			     void *hLOG, SIGN32 mem, SIGN32 tst);
...
///                                    ###
///     # # ----------------------------------------------------------
/// $ENDOFINTERFACE  # size:    4352B, bits:    8434b, padding:     0B
////////////////////////////////////////////////////////////
#ifndef h_dHubReg2D
#define h_dHubReg2D (){}
...
#define     RA_dHubReg2D_Cmd2D                             0x0D00
	///////////////////////////////////////////////////////////
#define     RA_dHubReg2D_ARR_2ND                           0x0F00
#define     RA_dHubReg2D_Cmd2ND                            0x0F00
	///////////////////////////////////////////////////////////
#define     RA_dHubReg2D_BUSY                              0x1080

#define     BA_dHubReg2D_BUSY_ST                           0x1080
#define     B16dHubReg2D_BUSY_ST                           0x1080
...
#define   MSK32dHubReg2D_BUSY_ST                              0x0000FFFF
	///////////////////////////////////////////////////////////
#define     RA_dHubReg2D_CH_ST                             0x10C0
	///////////////////////////////////////////////////////////
...
#define     w32dHubReg2D_BUSY                              {\
            UNSG32 uBUSY_ST                                    : 16;\
            UNSG32 RSVDx1080_b16                               : 16;\
          }
		union {
			UNSG32 u32dHubReg2D_BUSY;
	...
	///////////////////////////////////////////////////////////
	SIGN32 dHubReg2D_drvrd(SIE_dHubReg2D * p, UNSG32 base, SIGN32 mem,
			       SIGN32 tst);
	SIGN32 dHubReg2D_drvwr(SIE_dHubReg2D * p, UNSG32 base, SIGN32 mem,
			       SIGN32 tst, UNSG32 * pcmd);
	void dHubReg2D_reset(SIE_dHubReg2D * p);
	SIGN32 dHubReg2D_cmp(SIE_dHubReg2D * p, SIE_dHubReg2D * pie, char *pfx,
			     void *hLOG, SIGN32 mem, SIGN32 tst);
...
///               %%        28         # Stuffing bits...
///     # # ----------------------------------------------------------
/// $ENDOFINTERFACE  # size:       8B, bits:       8b, padding:     0B
////////////////////////////////////////////////////////////
...
#define        avioDhubChMap_vpp128b_MV_R1                              0x2
#define        avioDhubChMap_vpp128b_DINT_W                             0x3
#define        avioDhubChMap_vpp128b_DINT0_R                            0x4
#define        avioDhubChMap_vpp128b_GFX_PIP_R0                         0x5
#define        avioDhubChMap_vpp128b_PIP_R1                             0x6
#define        avioDhubChMap_vpp128b_GFX_R1                             0x7
#define        avioDhubChMap_vpp128b_DINT1_R                            0x8
#define        avioDhubChMap_vpp128b_1DSCL_W0                           0x9
#define        avioDhubChMap_vpp128b_1DSCL_W1                           0xA
/* Added for A0*/
#define        avioDhubChMap_vpp128b_MetaData_RD                        0xB
#define        avioDhubChMap_vpp128b_DBEDR_RD                           0xC
	///////////////////////////////////////////////////////////
...
#define        avioDhubChMap_aio64b_SA_R                                0x4
#define        avioDhubChMap_aio64b_PDM_MIC_CH1_W                       0x5
#define        avioDhubChMap_aio64b_PDM_MIC_CH2_W                       0x6
#define        avioDhubChMap_aio64b_HDMI_R                              0x7
#define        avioDhubChMap_aio64b_BCM_R                               0x8
#define        avioDhubChMap_aio64b_TT_R                                0x9
#define        avioDhubChMap_aio64b_HDMIRX_CH3_W                        0xA
#define        avioDhubChMap_aio64b_HDMIRX_CH4_W                        0xB
#define        avioDhubChMap_aio64b_HDMIRX_CH5_W                        0xC
#define        avioDhubChMap_aio64b_HDMIRX_CH6_W                        0xD
...
#define   SET16avioDhubChMap_aio64b(r16,v)                 _BFSET_(r16, 3, 0,v)
	...
	///////////////////////////////////////////////////////////
	SIGN32 avioDhubChMap_drvrd(SIE_avioDhubChMap * p, UNSG32 base,
				   SIGN32 mem, SIGN32 tst);
	SIGN32 avioDhubChMap_drvwr(SIE_avioDhubChMap * p, UNSG32 base,
				   SIGN32 mem, SIGN32 tst, UNSG32 * pcmd);
	void avioDhubChMap_reset(SIE_avioDhubChMap * p);
	SIGN32 avioDhubChMap_cmp(SIE_avioDhubChMap * p, SIE_avioDhubChMap * pie,
				 char *pfx, void *hLOG, SIGN32 mem, SIGN32 tst);
...
///     # # ----------------------------------------------------------
///               : vpp128bDhub_BANK0_START_ADDR 0x0
///               : vpp128bDhub_BANK0_SIZE 0x3200
///               : vpp128bDhub_BANK1_START_ADDR 0x3200
///               : vpp128bDhub_BANK1_SIZE 0x3200
///               : vpp128bDhub_BANK2_START_ADDR 0x6400
///               : vpp128bDhub_BANK2_SIZE 0x3200
///               : vpp128bDhub_BANK3_START_ADDR 0x9600
///               : vpp128bDhub_BANK3_SIZE 0x3200
///               : aio64bDhub_BANK0_START_ADDR 0x0
///               : aio64bDhub_BANK0_SIZE 0x1800
///     @ 0x00000 dummy                (P)
///               %unsigned 1  xxx
///               %%        31         # Stuffing bits...
///     # # ----------------------------------------------------------
...
#define        avioDhubTcmMap_vpp128bDhub_BANK0_SIZE       0x3200
#define        avioDhubTcmMap_vpp128bDhub_BANK1_START_ADDR 0x3200
#define        avioDhubTcmMap_vpp128bDhub_BANK1_SIZE       0x3200
#define        avioDhubTcmMap_vpp128bDhub_BANK2_START_ADDR 0x6400
#define        avioDhubTcmMap_vpp128bDhub_BANK2_SIZE       0x3200
#define        avioDhubTcmMap_vpp128bDhub_BANK3_START_ADDR 0x9600
#define        avioDhubTcmMap_vpp128bDhub_BANK3_SIZE       0x3200
#define        avioDhubTcmMap_aio64bDhub_BANK0_START_ADDR  0x0
#define        avioDhubTcmMap_aio64bDhub_BANK0_SIZE        0x1800
	///////////////////////////////////////////////////////////
...
#define     w32avioDhubTcmMap_dummy                        {\
		...
		union {
			UNSG32 u32avioDhubTcmMap_dummy;
	...
	///////////////////////////////////////////////////////////
	SIGN32 avioDhubTcmMap_drvrd(SIE_avioDhubTcmMap * p, UNSG32 base,
				    SIGN32 mem, SIGN32 tst);
	SIGN32 avioDhubTcmMap_drvwr(SIE_avioDhubTcmMap * p, UNSG32 base,
				    SIGN32 mem, SIGN32 tst, UNSG32 * pcmd);
	void avioDhubTcmMap_reset(SIE_avioDhubTcmMap * p);
	SIGN32 avioDhubTcmMap_cmp(SIE_avioDhubTcmMap * p,
				  SIE_avioDhubTcmMap * pie, char *pfx,
				  void *hLOG, SIGN32 mem, SIGN32 tst);
...
///                                    : vpp_inr0                 0x10
///                                                 ###
///                                                 * VBI Start Interrupt from Video Path
///                                                 ###
///                                    : vpp_inr1                 0x11
///                                                 ###
///                                                 * Reserved
...
///                                    : vpp_inr2                 0x12
///                                                 ###
///                                                 * HDMI-TX HDCP Interrupt
///                                                 ###
///                                    : vpp_inr3                 0x13
///                                                 ###
///                                                 * DDC controller Interrupt
///                                                 ###
///                                    : vpp_inr4                 0x14
///                                                 ###
///                                                 * DDC controller Interrupt
...
///                                    : vpp_inr6                 0x16
///                                                 ###
///                                                 * Active Video Start Interrupt from Video Path
///                                                 ###
///                                    : vpp_inr7                 0x17
///                                                 ###
///                                                 * Reserved
...
///                                    : vpp_inr9                 0x19
///                                                 ###
///                                                 * HDMI-RX Pipe Interrupt (End of Frame Interrupt)
///                                                 ###
///                                    : vpp_inr10                0x1A
///                                                 ###
///                                                 * HDMI-RX Interrupt
...
///                                    : aio_intr6                0x16
///                                                 ###
///                                                 * SPDIF-RX Change Over Interrupt
///                                                 ###
///                                    : aio_intr7                0x17
///                                                 ###
///                                                 * HDMI-RX Pipe Interrupt (End of Frame Interrupt)
...
///               %%        27         # Stuffing bits...
///     # # ----------------------------------------------------------
/// $ENDOFINTERFACE  # size:       8B, bits:      10b, padding:     0B
////////////////////////////////////////////////////////////
...
#define   SET16avioDhubSemMap_aio64b(r16,v)                _BFSET_(r16, 4, 0,v)
	...
	///////////////////////////////////////////////////////////
	SIGN32 avioDhubSemMap_drvrd(SIE_avioDhubSemMap * p, UNSG32 base,
				    SIGN32 mem, SIGN32 tst);
	SIGN32 avioDhubSemMap_drvwr(SIE_avioDhubSemMap * p, UNSG32 base,
				    SIGN32 mem, SIGN32 tst, UNSG32 * pcmd);
	void avioDhubSemMap_reset(SIE_avioDhubSemMap * p);
	SIGN32 avioDhubSemMap_cmp(SIE_avioDhubSemMap * p,
				  SIE_avioDhubSemMap * pie, char *pfx,
				  void *hLOG, SIGN32 mem, SIGN32 tst);
...
#define   SET32vppTcmEntry_dat(r32,v)                      _BFSET_(r32,31, 0,v)
	...
	///////////////////////////////////////////////////////////
	SIGN32 vppTcmEntry_drvrd(SIE_vppTcmEntry * p, UNSG32 base, SIGN32 mem,
				 SIGN32 tst);
	SIGN32 vppTcmEntry_drvwr(SIE_vppTcmEntry * p, UNSG32 base, SIGN32 mem,
				 SIGN32 tst, UNSG32 * pcmd);
	void vppTcmEntry_reset(SIE_vppTcmEntry * p);
	SIGN32 vppTcmEntry_cmp(SIE_vppTcmEntry * p, SIE_vppTcmEntry * pie,
			       char *pfx, void *hLOG, SIGN32 mem, SIGN32 tst);
...
//////
///
/// $INTERFACE vpp128bDhub             biu              (4,4)
///     ###
///     * vpp128bDhub register specification
///     ###
///     # # ----------------------------------------------------------
///     @ 0x00000                      (P)
///     # 0x00000 tcm0
///               $vppTcmEntry         tcm0              MEM   [12800]
///                                    ###
///                                    * Real tcm size is 12.5K*4 = 50KB
///                                    ###
///     @ 0x10000                      (P)
///     # 0x10000 dHub0
///               $dHubReg2D           dHub0             REG
...
///               %% 489472
///     # # ----------------------------------------------------------
/// $ENDOFINTERFACE  # size:  131072B, bits:    8466b, padding:     0B
////////////////////////////////////////////////////////////
...
#define     RA_vpp128bDhub_tcm0                            0x0000
	///////////////////////////////////////////////////////////
#define     RA_vpp128bDhub_dHub0                        ((berlin_chip_revision < \
                                                        BERLIN_BG4CDP_A0_EXT)?0x10000 : \
                                                        0x20000)
	///////////////////////////////////////////////////////////

	typedef struct SIE_vpp128bDhub {
		///////////////////////////////////////////////////////////
		SIE_vppTcmEntry ie_tcm0[12800];
		UNSG8 RSVD_tcm0[14336];
		///////////////////////////////////////////////////////////
		SIE_dHubReg2D ie_dHub0;
		///////////////////////////////////////////////////////////
		UNSG8 RSVDx11100[61184];
		///////////////////////////////////////////////////////////
	} SIE_vpp128bDhub;

	///////////////////////////////////////////////////////////
	SIGN32 vpp128bDhub_drvrd(SIE_vpp128bDhub * p, UNSG32 base, SIGN32 mem,
				 SIGN32 tst);
	SIGN32 vpp128bDhub_drvwr(SIE_vpp128bDhub * p, UNSG32 base, SIGN32 mem,
				 SIGN32 tst, UNSG32 * pcmd);
	void vpp128bDhub_reset(SIE_vpp128bDhub * p);
	SIGN32 vpp128bDhub_cmp(SIE_vpp128bDhub * p, SIE_vpp128bDhub * pie,
			       char *pfx, void *hLOG, SIGN32 mem, SIGN32 tst);
...
///     @ 0x00000                      (P)
///     # 0x00000 tcm0
///               $vppTcmEntry         tcm0              MEM    [6144]
///                                    ###
///                                    * Real tcm size is 6K*1= 6KB
///                                    ###
///     @ 0x08000                      (P)
///     # 0x08000 dHub0
///               $dHubReg2D           dHub0             REG
...
///               %% 227328
///     # # ----------------------------------------------------------
/// $ENDOFINTERFACE  # size:   65536B, bits:    8466b, padding:     0B
////////////////////////////////////////////////////////////
#ifndef h_aio64bDhub
#define h_aio64bDhub (){}
...
#define     RA_aio64bDhub_tcm0                             0x0000
	///////////////////////////////////////////////////////////
#define     RA_aio64bDhub_dHub0                         ((berlin_chip_revision < \
                                                        BERLIN_BG4CDP_A0_EXT)?0x8000 : \
                                                        0x10000)
	///////////////////////////////////////////////////////////

	typedef struct SIE_aio64bDhub {
		///////////////////////////////////////////////////////////
		SIE_vppTcmEntry ie_tcm0[6144];
		UNSG8 RSVD_tcm0[8192];
		///////////////////////////////////////////////////////////
		SIE_dHubReg2D ie_dHub0;
		///////////////////////////////////////////////////////////
		UNSG8 RSVDx9100[28416];
		///////////////////////////////////////////////////////////
	} SIE_aio64bDhub;

	///////////////////////////////////////////////////////////
	SIGN32 aio64bDhub_drvrd(SIE_aio64bDhub * p, UNSG32 base, SIGN32 mem,
				SIGN32 tst);
	SIGN32 aio64bDhub_drvwr(SIE_aio64bDhub * p, UNSG32 base, SIGN32 mem,
				SIGN32 tst, UNSG32 * pcmd);
	void aio64bDhub_reset(SIE_aio64bDhub * p);
	SIGN32 aio64bDhub_cmp(SIE_aio64bDhub * p, SIE_aio64bDhub * pie,
			      char *pfx, void *hLOG, SIGN32 mem, SIGN32 tst);
