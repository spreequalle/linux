...
#define HDMIRX_PHY_CAL_TRIG			(HDMI_RX_BASE + 0x0461)
#define HDMIRX_PHY_PM_TRIG			(HDMI_RX_BASE + 0x0462)
...
#define HDMI_RX_INT_VSYNC				0x04
#define HDMI_RX_INT_VSI_STOP			0x10
...
#define CPU_INTR_MASK0_EXTREG_ADDR		(SOC_AVIF_BASE+\
				((CPU_SS_MBASE_ADDR + 0x003D)<<2))
#define CPU_INTR_MASK1_EXTREG_ADDR		(SOC_AVIF_BASE+\
				((CPU_SS_MBASE_ADDR + 0x0020)<<2))
#define CPU_INTR_MASK2_EXTREG_ADDR		(SOC_AVIF_BASE+\
				((CPU_SS_MBASE_ADDR + 0x0021)<<2))
#define CPU_INTR_MASK3_EXTREG_ADDR		(SOC_AVIF_BASE+\
				((CPU_SS_MBASE_ADDR + 0x0022)<<2))
#define CPU_INTR_MASK4_EXTREG_ADDR		(SOC_AVIF_BASE+\
				((CPU_SS_MBASE_ADDR + 0x0023)<<2))

#define CPU_INTR_MASK0_STATUS_EXTREG_ADDR (SOC_AVIF_BASE+\
				((CPU_SS_MBASE_ADDR + 0x003E)<<2))
#define CPU_INTR_MASK1_STATUS_EXTREG_ADDR (SOC_AVIF_BASE+\
				((CPU_SS_MBASE_ADDR + 0x0028)<<2))
#define CPU_INTR_MASK2_STATUS_EXTREG_ADDR (SOC_AVIF_BASE+\
				((CPU_SS_MBASE_ADDR + 0x0029)<<2))
#define CPU_INTR_MASK3_STATUS_EXTREG_ADDR (SOC_AVIF_BASE+\
				((CPU_SS_MBASE_ADDR + 0x002A)<<2))
#define CPU_INTR_MASK4_STATUS_EXTREG_ADDR (SOC_AVIF_BASE+\
				((CPU_SS_MBASE_ADDR + 0x002B)<<2))

#define CPU_INTR_CLR0_EXTREG_ADDR		(SOC_AVIF_BASE+\
				((CPU_SS_MBASE_ADDR + 0x004D)<<2))
#define CPU_INTR_CLR1_EXTREG_ADDR		(SOC_AVIF_BASE+\
				((CPU_SS_MBASE_ADDR + 0x002C)<<2))
#define CPU_INTR_CLR2_EXTREG_ADDR		(SOC_AVIF_BASE+\
				((CPU_SS_MBASE_ADDR + 0x002D)<<2))
#define CPU_INTR_CLR3_EXTREG_ADDR		(SOC_AVIF_BASE+\
				((CPU_SS_MBASE_ADDR + 0x002E)<<2))
#define CPU_INTR_CLR4_EXTREG_ADDR		(SOC_AVIF_BASE+\
				((CPU_SS_MBASE_ADDR + 0x002F)<<2))

#define CPU_INTR_RAW_STATUS0_EXTREG_ADDR	(SOC_AVIF_BASE+\
				((CPU_SS_MBASE_ADDR + 0x003C)<<2))
#define CPU_INTR_RAW_STATUS1_EXTREG_ADDR	(SOC_AVIF_BASE+\
				((CPU_SS_MBASE_ADDR + 0x0024)<<2))
#define CPU_INTR_RAW_STATUS2_EXTREG_ADDR	(SOC_AVIF_BASE+\
				((CPU_SS_MBASE_ADDR + 0x0025)<<2))
#define CPU_INTR_RAW_STATUS3_EXTREG_ADDR	(SOC_AVIF_BASE+\
				((CPU_SS_MBASE_ADDR + 0x0026)<<2))
#define CPU_INTR_RAW_STATUS4_EXTREG_ADDR	(SOC_AVIF_BASE+\
				((CPU_SS_MBASE_ADDR + 0x0027)<<2))
#define CPU_INTCPU_2_EXTCPU_MASK0INTR_ADDR (SOC_AVIF_BASE+\
				(CPU_SS_MBASE_ADDR + 0x0048)*4)
#define CPU_INTCPU_2_EXTCPU_INTR0_ADDR (SOC_AVIF_BASE+\
				(CPU_SS_MBASE_ADDR + 0x003F)*4)
#define CPU_INTCPU_2_EXTCPU_INTR1_ADDR (SOC_AVIF_BASE+\
				(CPU_SS_MBASE_ADDR + 0x0040)*4)
#define CPU_INTCPU_2_EXTCPU_INTR2_ADDR (SOC_AVIF_BASE+\
				(CPU_SS_MBASE_ADDR + 0x0041)*4)
#define CPU_INTCPU_2_EXTCPU_INTR3_ADDR (SOC_AVIF_BASE+\
				(CPU_SS_MBASE_ADDR + 0x0042)*4)
#define CPU_INTCPU_2_EXTCPU_INTR4_ADDR (SOC_AVIF_BASE+\
				(CPU_SS_MBASE_ADDR + 0x0043)*4)
#define CPU_INTCPU_2_EXTCPU_INTR5_ADDR (SOC_AVIF_BASE+\
				(CPU_SS_MBASE_ADDR + 0x0044)*4)
#define CPU_INTCPU_2_EXTCPU_INTR6_ADDR (SOC_AVIF_BASE+\
				(CPU_SS_MBASE_ADDR + 0x0045)*4)
#define CPU_INTCPU_2_EXTCPU_INTR7_ADDR (SOC_AVIF_BASE+\
				(CPU_SS_MBASE_ADDR + 0x0046)*4)
...
#else
#define RA_HDRX_INTR_EN			(SOC_HDMIRX_BASE + 0x0160)
#define RA_HDRX_INTR_EN1		(SOC_HDMIRX_BASE + 0x0164)
#define RA_HDRX_INTR_STATUS		(SOC_HDMIRX_BASE + 0x0168)
#define RA_HDRX_INTR_STATUS1	(SOC_HDMIRX_BASE + 0x016c)
#define RA_HDRX_INTR_CLR		(SOC_HDMIRX_BASE + 0x0170)
#define RA_HDRX_INTR_CLR1		(SOC_HDMIRX_BASE + 0x0174)
#endif
#endif
#endif	  /*_DRV_AVIF_H_*/
