...
#define	MTD_CONFIG_PART_SIZE CONFIG_CFG_PART_SIZE

#ifdef SUPPORT_LANG_PART
#define	MTD_LANG_PART_SIZE	CONFIG_LANG_PART_SIZE
#else		// SUPPORT_LANG_PART
#define	MTD_LANG_PART_SIZE	0
#endif	// SUPPORT_LANG_PART

#ifdef SUPPORT_POT_PART
#define	MTD_POT_PART_SIZE	CONFIG_POT_PART_SIZE
#else		// SUPPORT_POT_PART
#define	MTD_POT_PART_SIZE	0
#endif	// SUPPORT_POT_PART

#ifdef SUPPORT_CHECKSUM_PART
#define	MTD_CHECKSUM_PART_SIZE	CONFIG_CHECKSUM_PART_SIZE
#else		// SUPPORT_CHECKSUM_PART
#define	MTD_CHECKSUM_PART_SIZE	0
#endif	// SUPPORT_CHECKSUM_PART
...
#define MTD_STATIC_PART_SIZE MTD_BOOT_PART_SIZE + MTD_CONFIG_PART_SIZE + MTD_FACTORY_PART_SIZE \
									  + CONFIG_MTD_KERNEL_PART_SIZ


#define MTD_ROOTFS_PART_SIZE	IMAGE1_SIZE - (MTD_STATIC_PART_SIZE + MTD_LANG_PART_SIZE + MTD_POT_PART_SIZE + MTD_CHECKSUM_PART_SIZE)
