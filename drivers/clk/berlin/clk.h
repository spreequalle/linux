...
struct berlin_avplldata {
	...
	const struct clk_ops	*avpll_ops;
	const struct clk_ops	*avpllch_ops;
	struct berlin_avpll	*avpll_table[2];
};
...
extern void __init berlin_avpll_sysfs_init(struct berlin_avplldata *data);
