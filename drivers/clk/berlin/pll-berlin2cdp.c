...
static void __init berlin2cdp_pll_setup(struct device_node *np)
{
	berlin_pll_setup(np, &berlin2cdp_pll_ops);
}
CLK_OF_DECLARE(berlin2cdp_pll, "marvell,berlin2cdp-pll", berlin2cdp_pll_setup);
...
static void __init berlin2cdp_avpll_setup(struct device_node *np)
{
	berlin_avpll_setup(np, &avpll_data);
}
CLK_OF_DECLARE(berlin2cdp_avpll, "marvell,berlin2cdp-avpll",
	       berlin2cdp_avpll_setup);
